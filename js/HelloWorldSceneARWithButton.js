        ...
        <ViroARImageMarker  target={"targetTwo"}>
          <ViroNode rotation={[-90, 0, 0]} scale={[.2, .2, .2]}>
            ...
            <Viro3DObject
              ...
              resources={[require('./res/iPhone_6/iPhone 6.mtl')]}
              materials={["phone"]}            
              highAccuracyGaze={true}   
              position={[0, 0, 0]}
              scale={[.1, .1, .1]}
...
ViroAnimations.registerAnimations({
  ...
  ViroMaterials.createMaterials({
    note: {
       lightingModel: "Blinn",
       diffuseTexture: require('./res/note/textures/texture(3).jpg')
     },
    tela: {
       lightingModel: "Blinn",
       diffuseTexture: require('./res/note/textures/texture(2).jpg')
     },
    phone: {
       lightingModel: "Blinn",
       diffuseTexture: require('./res/iPhone_6/Textures/iphone-6-02.jpg')
     },
  });
...
ViroARTrackingTargets.createTargets({
      ...
      "targetTwo" : {
        source : require('./res/iPhone_6/imagePhone.jpg'),
        orientation : "Up",
        physicalWidth : 0.1 // real world width in meters
      },
      });
